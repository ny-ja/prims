        ...
        <TableContainer>
            <template #filter>
                <SelectFilter :filters="filters" routeName="admin.residents.index"
                    :options="['Formal', 'Indigent', 'Solo Parent', 'PWD', 'Indigenous', 'Senior Citizen']"
                    filterKey="social_classification" />
            </template>

            <template #download>
                <form method="GET" :action="route('admin.residents.index')">
                    <input type="hidden" name="search" :value="filters.search">
                    <input type="hidden" name="social_classification" :value="filters.social_classification">
